...
namespace Owin.Security.Providers.StackExchange
{
    public class StackExchangeAuthenticationOptions : AuthenticationOptions
    {
        ...
        /// <summary>
        ///     Gets or sets the <see cref="IStackExchangeAuthenticationProvider" /> used in the authentication events
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new <see cref="StackExchangeAuthenticationOptions" />
        /// </summary>
